...
NEconomy = {
	...
	PATRICIAN_CAMPAIGN_FUND_FACTOR = 2,				-- The effect of money in the Campaign Fund on Doge elections (money * factor)
	PATRICIAN_PRESTIGE_RESPECT_FACTOR = 5,			-- The effect of Prestige on the Respect value for Doge elections (prestige * factor)
...
NNomad = {
	...
	MAX_POPULATION_EMPTY_HOLDING_MULTIPLIER = 2000,  -- Max population increase for each empty holding in provinces where the capital is also an empty holding
...
NTechnology = {
	DONT_EXECUTE_TECH_BEFORE = 417,				-- Set this to your earliest starting year
	...
	IDEAL_YEAR_LEVEL_0 = 417, 					-- the chance to get a progress to this level will increase after this date and decrease before it
